...
The goal of regexcite.jjadeb is to make regular expressions more exciting!
...
You can install the development version of regexcite.jjadeb from [GitHub](https://github.com/jjadeb/string_split_r_package) with:
