...
The goal of regexcite.jjadeb is to make regular expressions more
...
You can install the development version of regexcite.jjadeb from
[GitHub](https://github.com/jjadeb/string_split_r_package) with:

``` r
# install.packages("devtools")
devtools::install_github("jjadeb/string_split_r_package")
```
...
That’s exactly what `regexcite.jjadeb::str_split_one()` does.

``` r
library(regexcite.jjadeb)
